...
public class Record {
	...
	public static void main(String[] args) throws Exception {
        ...
        case 1: 
    		...
    		String qry= "insert into Student1  values("+ regdno + " , '"+ stdname+ "', '"+branch+ "' , "+ mark+")";
        ...
        case 2:
    		...
    		String qry1="update Student set stdnam='"+stdname1+"', branch='"+branch1+"', marks="+mark1+" where regdno="+regdno1;                   
...
//    			System.out.println(rs.getInt("regdno") + ", " + rs.getString("stdname")+ ", " +rs.getString("branch")+", "+rs.getInt("mark"));
        ...
        case 4:
        	...
        	String qry2 = "delete from student where regdno = "+regdno2;
